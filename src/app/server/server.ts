...
/* Path of client files */
const clientVersionPath: string = path.resolve(__dirname, '..', 'client');
...
app.use(express.static(clientVersionPath));
...
app.set('views', clientVersionPath);
